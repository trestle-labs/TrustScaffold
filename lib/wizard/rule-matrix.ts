...
export const wizardRuleMatrix: WizardRule[] = [
  ...
  },
  {
    ...
    summary: 'Customer PII is already selected in System Scope, but Privacy is still out of scope in the TSC step.',
    criteria: ['P1-P8'],
    severity: 'warning',
    ...
    when: (data) => data.scope.dataTypesHandled.includes('Customer PII') && !data.tscSelections.privacy,
  },
  {
  ...
  },
  {
    ...
    summary: 'The review step still sees customer PII in scope without Privacy TSC selected.',
    criteria: ['P1-P8'],
    severity: 'warning',
  ...
  },
  {
    ...
    summary: 'The system handles customer PII, but Privacy TSC is not selected.',
    criteria: ['P1-P8'],
    severity: 'warning',
