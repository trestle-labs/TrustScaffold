...
export const wizardRuleMatrix: WizardRule[] = [
  ...
  },
  {
    ...
    when: (data) => data.company.websiteCollectsPersonalData && !data.company.websiteHasPrivacyNotice,
  },
  {
    ...
    when: (data) => data.company.websiteUsesCookiesAnalytics && !data.company.websiteHasCookieBanner,
  },
  {
    ...
    when: (data) => !data.tscSelections.privacy && (data.company.websiteCollectsPersonalData || data.company.websiteTargetsEuOrUkResidents || data.company.websiteTargetsCaliforniaResidents || data.company.websiteSellsOrSharesPersonalInformation || data.company.websiteAllowsChildrenUnder13),
  },
  {
