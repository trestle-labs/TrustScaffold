...
const SECURITY_TEMPLATES: TemplateManifestEntry[] = [
  ...
  { name: 'Access Control and On/Offboarding Policy', tsc: 'Security', criteriaHint: 'CC6', description: 'Governs how access is granted to systems and revoked when employees leave. Incorporates your termination SLA and HRIS provider.' },
  ...
  { name: 'Secure Software Development Life Cycle Policy', tsc: 'Security', criteriaHint: 'CC8', description: 'Defines security requirements throughout your software development lifecycle — from design and code review through testing and deployment.' },
  ...
  { name: 'Acceptable Use and Code of Conduct Policy', tsc: 'Security', criteriaHint: 'CC1, CC2', description: 'Establishes rules for how employees use company systems, devices, and data. References your MDM, endpoint protection, and data classification choices.' },
  { name: 'Internal Audit and Monitoring Policy', tsc: 'Security', criteriaHint: 'CC2, CC4', description: 'Describes how your organization monitors controls, reviews security logs, and conducts internal assessments. Maps to your SIEM and audit program settings.' },
  { name: 'Data Retention and Disposal Policy', tsc: 'Security', criteriaHint: 'CC6, CC9', description: 'Defines how long different data types are retained and how data is securely destroyed at end of life. Populated from your retention schedule settings.' },
