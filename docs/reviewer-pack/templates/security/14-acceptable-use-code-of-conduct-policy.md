...
| Criteria mapped | CC1, CC2 |
| Purpose | Workforce expectations for lawful, ethical, and secure use of company systems. |
| Output filename | `14-acceptable-use-code-of-conduct-policy.md` |
