...
set
  criteria_mapped = array['CC1', 'CC2', 'CC3', 'CC4', 'CC5', 'CC6', 'CC7', 'CC8', 'CC9'],
  markdown_template = $$---
...
where slug = 'internal-audit-monitoring-policy'
  and markdown_template like '%Policy acknowledgements are verified per the established cadence ({{acknowledgement_cadence}}).%';